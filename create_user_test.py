...
# Тест 3. Ошибка. Количество символов меньше допустимого (1)
# Параметр fisrtName состоит из 1 символа
def test_create_user_1_letter_in_first_name_get_error_response():
    negative_assert_symbol("А")


# Тест 4. Ошибка. Количество символов больше допустимого (16)
# Параметр fisrtName состоит из 16 символа
def test_create_user_16_letter_in_first_name_get_error_response():
    negative_assert_symbol("Аааааааааааааааа")


# Тест 5. Успешное создание пользователя. Разрешены английские буквы
# Параметр fisrtName состоит из английских букв
def test_create_user_english_letter_in_first_name_get_success_response():
    positive_assert("QWErty")


# Тест 6. Успешное создание пользователя. Разрешены русские символы
...
# Тест 8. Ошибка. Запрещены символы
...
# Параметр fisrtName состоит из строки цифрами
def test_create_user_has_number_in_first_name_get_error_response():
    negative_assert_symbol("123")


# Функция для негативной проверки - пустое значение
...
# Тест 11. Ошибка. Передано пустое значение параметра
...
# Тест 12. Ошибка. Передан другой тип параметра firstName: число
# Параметр fisrtName состоит другого типа параметра - числа
